...
public class MainActivity extends AppCompatActivity implements
    ...
    public void refreshPlacesData() {
        // Get all the Places IDs from the database
        ...
        // the .toArray() method copies the contents of the ArrayList to another array. So inside it
        // we also initialize a new String[] array.
        ...
        // The PendingResult returns a PlaceBuffer. To retrieve the server's response, we need to set
        // a corresponding callback for the pending result
        placeResult.setResultCallback(new ResultCallback<PlaceBuffer>() {
            @Override
            public void onResult(@NonNull PlaceBuffer places) {
                // We want to update the RecyclerView when we receive new data
